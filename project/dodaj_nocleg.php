...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO nocleg(nazwa,adres_wycieczki)
            VALUES('{$nazwa}','{$adres}')";
    ...
    <div class="wrapper">
     <form method="post">
      ...
      <div class="form-group">
          ...
          <input type="text" name="nazwa" class="form-control" placeholder="Nazwa noclegu">
      </div>

      <div class="form-group">
          <label>Adres noclegu</label>
          <input type="text" name="adres" class="form-control" placeholder="Adres noclegu">
      </div>
